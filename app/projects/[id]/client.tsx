                    ...
                    <div className="flex flex-wrap gap-4">
                        ...
                        {project.demoVideo && (
                            <a 
                                ...
                                target="_blank"
                                rel="noopener noreferrer"
                                className="inline-flex items-center gap-2 bg-card border border-border text-foreground px-6 py-3 rounded-lg font-medium hover:bg-muted transition-colors shadow-sm hover:shadow-md hover:-translate-y-0.5 duration-300"
                            >
